...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      "  overflow:hidden;max-width:86px;max-height:65px;",
      ...
      "  max-width:500px;max-height:inherit;min-width:260px;background:#fff;gap:10px;",
      "  " + (posRight ? "padding:8px 5px 8px 20px;" : "padding:8px 20px 8px 5px;"),
      "  box-shadow:0 2px 16px rgba(0,0,0,0.10),0 1px 4px rgba(0,0,0,0.06);",
      "}",
      ".cf360-teaser-content{display:flex;flex-direction:column;align-items:stretch;gap:6px;opacity:0;pointer-events:none;transition:opacity 0.15s ease;text-align:center;}",
      ".cf360-teaser--expanded .cf360-teaser-content{opacity:1;pointer-events:auto;transition-delay:0.2s;flex:1;}",
      ...
      "  .cf360-teaser{position:fixed;bottom:16px;" + (posRight ? "right:0;" : "left:0;") + "max-width:85px;}",
